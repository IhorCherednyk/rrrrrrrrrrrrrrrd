...
class BobController extends SiteController {
    ...
    public function generateDataForArray() {
        ...
        $this->dataGlobalArray = [
                [
                'match' => 'Челси - Вест Бромвич',
                'refery' => [
                    'name' => 'Мэйсон'
                ],
            ],
                [
                'match' => 'Саутгемптон - Ливерпуль',
                'refery' => [
                    'name' => 'Аткинсон'
                ],
            ],
                [
                'match' => 'Ньюкасл - Манчестер Ю',
                'refery' => [
                    'name' => 'Поусон'
                ],
            ],
                [
                'match' => 'Хаддерсфилд - Борнмут',
                'refery' => [
                    'name' => 'Оливер'
                ],
            ],
                [
                'match' => 'Манчестер С - Лестер',
                'refery' => [
                    'name' => 'Джонс'
                ],
            ],
                ...
                [
                'match' => 'Эвертон - Кр. Пэлэс',
                'refery' => [
                    'name' => 'Мосс'
                ],
            ],
                [
                'match' => 'Вест Хэм - Уотфорд',
                'refery' => [
                    'name' => 'Скотт'
                ],
            ],
            ...
            [
                ...
                [
                'match' => 'Ливерпуль - Тоттенхэм',
                'refery' => [
                    'name' => 'Мосс'
                ],
            ],
                [
                'match' => 'Кр. Пэлэс - Ньюкасл',
                'refery' => [
                    'name' => 'Марринер'
                ],
            ],
                [
                'match' => 'Арсенал - Эвертон',
                'refery' => [
                    'name' => 'Суорбрик'
                ],
            ],
                [
                'match' => 'Вест Бромвич - Саутгемптон',
                'refery' => [
                    'name' => 'Оливер'
                ],
            ],
                ...
                [
                'match' => 'Манчестер Ю - Хаддерсфилд',
                'refery' => [
                    'name' => 'Атвелл'
                ],
            ],
                [
                'match' => 'Брайтон - Вест Хэм',
                'refery' => [
                    'name' => 'Ист'
                ],
            ],
