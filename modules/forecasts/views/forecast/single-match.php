...
$this->title = $model->team1->name . ' vs ' . $model->team2->name;
?>
...
<section class="main-section match-sect single-match">
    <div class="match-sect-wrapper">
        ...
        <?php foreach ($model->matchesKoffs as $key => $koff): ?>
                        ...
                        <div class="col-sm-3">
                            <a class="booker-avatar" target="_blank" href="">
                                <span class="tournament-icon">
                                    <?= Html::img($koff->book->img_medium) ?>
                                </span>
                            </a>
                        </div>
                        <div class="col-sm-5">
                            <div class="match-coff-detail">
                                <span class="coff-team1"><?= $model->team1->name ?></span>
                                <span class="coff-detail-numbers">
                                    <span class="first-coeff text-success"><?= $koff->team1_koff ?></span> 
                                    - 
                                    <span class="second-coeff text-danger"><?= $koff->team2_koff ?></span>
                                </span>
                                <span class="coff-team1"><?= $model->team2->name ?></span>
                            </div>
                        </div>
